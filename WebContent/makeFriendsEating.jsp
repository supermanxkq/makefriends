            ...
            <div class="head-right">
                <div class="top-nav">
                    <ul class="res">
                        ...
                        <li><a class="active" href="makeFriendsEating.jsp">交友点</a></li>
...
<%
	...
	String typeUser[] = findType.getType("吃货陪");	
    ...
    <div class="container">
        <div class="portfolio-main">
            <div class="portfolio-top">
                <h3>welcome to our 吃货街</h3>
                <p>找到做好吃的，知道最好的吃友，这里的吃货会出乎你的意料</p>
            </div>
            <div class="portfolio-bottom">
                ...
                <div class="view view-third">
                    <a href="#"><img src="images/c1.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/c2.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/c3.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/c4.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/c5.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/c6.jpg" alt="" class="img-responsive">
                        <div class="mask">
