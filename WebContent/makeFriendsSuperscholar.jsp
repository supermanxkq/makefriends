...
<title>makeFriendsSuperscholar</title>
			...
			<div class="head-right">
			  <div class="top-nav">
                  <ul class="res">
                      ...
                      <li><a class="active" href="makeFriendsSuperscholar.jsp">交友点</a></li>
...
<%
	...
	String typeUser[] = findType.getType("学霸型");	
	...
	<div class="container">
		<div class="portfolio-main">
			<div class="portfolio-top">
				<h3>welcome to our 学霸室</h3>
				<p>学霸室发生故事在这里我们一一上演，有的不仅仅是一点点哦！</p>
			</div>
			<div class="portfolio-bottom">
			  ...
			  <div class="view view-third">
                    <a href="#"><img src="images/p1.jpg" alt="" class="img-responsive" >
                    <div class="mask">
               ...
               <div class="view view-third">
                    <a href="single.jsp"><img src="images/p2.jpg" alt="" class="img-responsive">
                    <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/p3.jpg" alt="" class="img-responsive">
                    <div class="mask">
                ...
                <div class="view view-third">
                     <a href="single.jsp"><img src="images/p4.png" alt="" class="img-responsive">
                    <div class="mask">
                ...
                <div class="view view-third">
                     <a href="single.jsp"><img src="images/p5.jpg" alt="" class="img-responsive">
                    <div class="mask">
                ...
                <div class="view view-third">
                     <a href="single.jsp"><img src="images/p6.jpg" alt="" class="img-responsive">
                    <div class="mask">
			...
			<div class="portfolio-bottom tuij">
                ...
                <div class="row" style="margin-left: 2px;margin-right: 2px;margin-top: 10px;">
                    ...
                    <div class="col-md-2">
                        <a href="" style="text-decoration: none;">
                            <img src="images/i3.jpg" alt="" class="img-responsive" style="margin-top: 7px;margin-bottom: 7px;">
	...
	<div class="container">
		...
		<div class="footer-main">
			<div class="col-md-12 footer-grid">
                ...
                <div class="ftr-sub-gd">
                    <div class="col-md-3 ftr-gd1-img">
                        <a href="#"><img src="images/f2.jpg" alt="" class="img-responsive" style="width: 200px;height: 100px;"></a>
                    </div>
                    <div class="col-md-9 ftr-gd1-text">
                ...
                <div class="ftr-sub-gd">
                    <div class="col-md-3 ftr-gd1-img">
                        <a href="#"><img src="images/f3.jpg" alt="" class="img-responsive" style="width: 200px;height: 100px;"></a>
                    </div>
                    <div class="col-md-9 ftr-gd1-text">
                        <h4><a href="#">胖妞的世界</a></h4>
                        <p><a href="#">我不是一夜之间胖起来的，但是我却仿佛在一夜之间被肥胖给毁灭了。 那是几年前我更加年轻的时候，我和我的第N任男朋友在饭店里吃一顿丰盛的自助餐。我在故意错过一顿午饭的情况下，
