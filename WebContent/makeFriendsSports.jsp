            ...
            <div class="head-right">
                <div class="top-nav">
                    <ul class="res">
                        ...
                        <li><a class="active" href="makeFriendsSports.jsp">交友点</a></li>
...
<%
	...
	String typeUser[] = findType.getType("运动");	
    ...
    <div class="container">
        <div class="portfolio-main">
            <div class="portfolio-top">
                <h3>welcome to our 运动区</h3>
                <p>阳光下的白衬衫永远都那么帅！这里有你的运动搭档，let's do sports</p>
            </div>
            <div class="portfolio-bottom">
                ...
                <div class="view view-third">
                    <a href="#"><img src="images/y1.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/y2.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/y3.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/y4.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/y5.jpg" alt="" class="img-responsive">
                        <div class="mask">
                ...
                <div class="view view-third">
                    <a href="single.jsp"><img src="images/y6.jpg" alt="" class="img-responsive">
                        <div class="mask">
        ...
        <div class="footer-main">
            <div class="col-md-12 footer-grid">
                ...
                <div class="ftr-sub-gd">
                    ...
                    <div class="col-md-9 ftr-gd1-text">
                        <h4><a href="#">五彩缤纷的“吃”</a></h4>
                        <p><a href="#">赴美留学，攻读我最喜爱的食品营养学专业。这是一个偏僻的大学城，我的心一下子冷了不少。 一桌美食俘获学生心 开学第一天的迎新会，就把我的胃抓住了。进了大礼堂一看，
                        这分明是先搞定我们的嘴啊！面前摆了一桌子的美食，肉丸子、炸鸡翅、沙拉、面包、玉米...
                        </a>
                        </p>
                        <p class="mk-p"><a href="" class="mk-a">更多</a></p>
                    </div>
